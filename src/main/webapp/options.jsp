...
<nav class="navbar navbar-inverse">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="user.jsp" style="font-size: 40px;"><b>Piyush Cinema</b></a>
    </div>
  </div>
</nav>
	    ...
	    <table class="table table-hover" style="margin-top: 350px;">
	        ...
	        <tbody>
	            ...
	            <%
	                ...
	                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db", "root", "Kolkata@123");
	                Statement stmt = null;
